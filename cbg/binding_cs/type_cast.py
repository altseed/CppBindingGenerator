...
T = TypeVar('T')
def _type_cast(self:BindingGeneratorCS, type_:T, name:str, definition:Definition, called_by:ArgCalledBy):
    ptr = ''
...
U = TypeVar('U')
def _return_cast(self:BindingGeneratorCS, type_:T, name:str, definition:Definition):
